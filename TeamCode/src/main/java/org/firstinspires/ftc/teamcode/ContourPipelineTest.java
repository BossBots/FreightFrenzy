...
// Credits in ContourPipeline.java

// Uses ContourPipeline.java
@TeleOp
public class ContourPipelineTest extends LinearOpMode {
    ...
    private double crThreshLow;
    private double cbThreshLow;
    private double crThreshHigh;
    private double cbThreshHigh;
    ...
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 255.0, 0.0);
